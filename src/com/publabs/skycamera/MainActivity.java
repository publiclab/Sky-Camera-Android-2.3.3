...
public boolean minacc(LinkedList<Float> b){
	Log.i("minacc", " Threshold = "+ threshold);
...
public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,String key) {
    String timex = prefs.getString("time", "25");
    String mailidx = prefs.getString("mail", "");
    String threshold1x = prefs.getString("threshold", "");
    if(!(timex.equalsIgnoreCase(time1))){
    	time = timex;
    ...
    else if(!(mailidx.equalsIgnoreCase(mailid1))){
    	mailid = mailidx;
    	Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
        finish();
    ...
    else if(!(threshold1x.equalsIgnoreCase(threshold2))){
    	threshold1 = threshold1x;
    	Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
        finish();
    } 
